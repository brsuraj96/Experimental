...
const IconSudoku: React.FC<IconProps> = ({
  size = 24,
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G>
        ...
        {/* Numbers */}
        <Path d="M16.5 5L17.5 5L17.5 6L16.5 6L16.5 5Z" fill={color} />
        <Path d="M10.5 11L11.5 11L11.5 12L10.5 12L10.5 11Z" fill={color} />
        <Path d="M4.5 18L5.5 18L5.5 19L4.5 19L4.5 18Z" fill={color} />
      </G>
    </Svg>
  );
};
