...
const MatchstickGame: React.FC<MatchstickGameProps> = ({
  ...
  const [selectedMatchstick, setSelectedMatchstick] = useState<Matchstick | null>(null);
  ...
  const handleSelectMatchstick = useCallback((matchstick: Matchstick) => {
    if (!level) return;
  ...
  const handleMoveMatchstick = useCallback((dx: number, dy: number) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.equationContainer}>
        ...
        <Text style={styles.targetText}>Target: {level.puzzle.targetEquation}</Text>
      </View>
